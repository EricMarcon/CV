...
Chef de la division de Charleville-Rocroi.
4 groupes techniques, 28 collaborateurs, 15 ouvriers forestiers, 29000 hectares de forêt productive (dont 65 forêts communales).
...
::: aside
<i class="fa fa-globe"></i> [UMR Amap](https://amap.cirad.fr/)
:::
...
::: aside
<i class="fa fa-globe"></i> [Master BioGET](https://biologie-ecologie.com/master-bee/bioget/)
:::
...
::: aside
<i class="fa fa-globe"></i> [DA Geeft](https://www.genv-agroparistech.fr/fr/nos-formations/ingenieur-agroparistech-da-geeft)
:::
...
::: aside
<i class="fa fa-globe"></i> [Master EFT](https://www.ecofog.gf/spip.php?rubrique47)
:::
...
::: aside
<i class="fa fa-globe"></i> [Master Global Forestry](https://globalforestry.eu/)
:::
...
AuthorID %>% 
  ...
  ggplot(aes(year, cites)) +
    ...
    labs(
      title = "Citations par année (Google Scholar)",
...
Package R pour mesurer la diversité.
